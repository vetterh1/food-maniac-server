  ...
  */
  describe('Mark Creation', () => {
    ...
    it('it should fail creating an existing mark', (done) => {
      const mark = new Mark({ cuid: 'cuidTestPost2times', mark: 25 });
  ...
  */
  describe('Mark Update', () => {
    it('it should succeed updating a complete mark', (done) => {
      const markOrig = new Mark({ cuid: 'cuidUpdate1', mark: 40 });
      const markUpdt = { mark: 50 };
      markOrig.save(() => {
        chai.request(app)
    ...
    it('it should fail updating the cuid', (done) => {
      const markOrig = new Mark({ cuid: 'cuidUpdateCuid', mark: 64 });
      markOrig.save(() => {
        chai.request(app)
    ...
    it('it should fail updating with wrong mark info', (done) => {
      const markOrig = new Mark({ cuid: 'cuidUpdateIncomplete', mark: 82 });
      markOrig.save(() => {
        chai.request(app)
  ...
  */
  describe('Mark Retrieval', () => {
    ...
    it('it should find an existing mark', (done) => {
      const mark = new Mark({ cuid: 'cuidTestRetreive', mark: 92 });
      mark.save((err, markSaved) => {
        chai.request(app)
          ...
          .end((err2, res) => {
            ...
            res.body.should.have.property('mark');
            res.body.mark.should.be.a('object');
            res.body.mark.should.have.property('mark').eql(markSaved.mark);
            done();
          });
      });
    });
  ...
  */
  describe('Mark Deletion', () => {
    ...
    it('it should delete an existing mark', (done) => {
      const mark = new Mark({ cuid: 'cuidTestDelete', mark: 92 });
      mark.save(() => {
        chai.request(app)
