// i18n
export const REQUEST_LANGUAGE_INFO = 'REQUEST_LANGUAGE_INFO';
export const REQUEST_CURRENT_LANGUAGE = 'REQUEST_CURRENT_LANGUAGE';
export const CHANGE_LANGUAGE = 'CHANGE_LANGUAGE';
export const SETUP_LANGUAGES = 'SETUP_LANGUAGES';
